...
public class MetricalLpcfgHead implements Comparable<MetricalLpcfgHead>, Serializable {
	...
	/**
	 * Get a new head with its {@link #startQuantum} shifted right by some length.
	 * 
	 * @param shiftLength The length to shift {@link #startQuantum} by.
	 * @return A new head, with its {@link #startQuantum} shifted.
	 */
	public MetricalLpcfgHead getShifted(double shiftLength) {
		return new MetricalLpcfgHead(length, startQuantum + shiftLength, tiesIn);
	}
