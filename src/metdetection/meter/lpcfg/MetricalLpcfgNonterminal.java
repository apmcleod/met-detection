...
public class MetricalLpcfgNonterminal implements MetricalLpcfgNode, Serializable {
	...
	public MetricalLpcfgTerminal getTerminal() {
		...
		MetricalLpcfgQuantum[] quantums = new MetricalLpcfgQuantum[quantumsList.size()];
		quantumsList.toArray(quantums);
		
		return new MetricalLpcfgTerminal(quantums, getLength());
	}
