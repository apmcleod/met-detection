...
public class SmoothingUtils {
	 ...
	 * 
	 * @param frequencyCounts A Map of the frequency of an object to the number of objects with that frequency.
	 * We will decrement 1 from this Map.
	 * @param frequency The frequency whose count we want to decrement.
	 */
	public static void removeFrequency(Map<Integer, Integer> frequencyCounts, int frequency) {
		int newCount = frequencyCounts.get(frequency) - 1;
		
		if (newCount == 0) {
			frequencyCounts.remove(frequency);
